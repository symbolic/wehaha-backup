function initFastSection() {
    function t() {
        if (!$(".J_fastSectionList").hasClass('is_ajaxing')) {
            $(".J_fastSectionList .bugs-more a").text('Loading...');
            $(".J_fastSectionList").addClass('is_ajaxing');
            page = 1;
    ...
    function e() {
        if ("desktop" == deviceType) {
            var e = window.innerHeight - 450;            
            if(e < 400){
               e = e + 250;
               $('.wechatt').hide();
            }
            var t = $(".J_fastSectionList .wrap").height(); ! $(".J_fastSectionList .wrap").data("origin") && $(".J_fastSectionList .wrap").data("origin", t),
            $(".J_fastSectionList .wrap").height(e),
    ...
    $(".J_fastSectionList .tabs a").each(function(t) {
        $(this).click(function(n) {
            if (n.preventDefault(), $(this).addClass("active").siblings().removeClass("active"), $(".J_fastSectionList .panel").eq(t).show().siblings().hide(), $(".J_fastSectionList .wrap").perfectScrollbar("update"), e(), $(window).trigger("resize"), $(this).attr("name")) {
                var i = ("sideActiveTab=" + $(this).attr("name"), new RegExp("(&|\\?)sideActiveTab=.+(&|$)")),
                r = location.hash.replace(i, "");
                location.hash = r + (r.indexOf("?") > -1 ? "&sideActiveTab=" + $(this).attr("name") : "?sideActiveTab=" + $(this).attr("name"))
            }
        })
    }),
    ...
    function e() {
        ...
        $("[data-lazyload]").each(function() {
            ...
            if ($(this).data("lazyload") && (n.addClass("before-fade-in"), e > t && $(this).data("lazyload"))) {
                ...
                1 == n.data("fitMobile") && "desktop" != deviceType && (i = i.replace(/\!.+$|$/, "!appfeed2x")),
...
function(e, t) {
    ...
    function x(e, t, n) {
        ...
        n && ("" !== a || Z.contains(e.ownerDocument, e) || (a = Z.style(e, t)), Ft.test(a) && qt.test(t) && (i = s.width, r = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = i, s.minWidth = r, s.maxWidth = o)),
        void 0 !== a ? a + "": a
    }
    function k(e, t) {
        return {
    ...
    function $(e, t, n) {
        ...
        if (0 >= r || null == r) {
            if (r = x(e, t, o), (0 > r || null == r) && (r = e.style[t]), Ft.test(r)) return r;
    ...
    function S(e, t) {
        ...
        i.style && (o[a] = vt.get(i, "olddisplay"), n = i.style.display, t ? (o[a] || "none" !== n || (i.style.display = ""), "" === i.style.display && Tt(i) && (o[a] = vt.access(i, "olddisplay", w(i.nodeName)))) : (r = Tt(i), "none" === n && r || vt.set(i, "olddisplay", r ? n: Z.css(i, "display"))));
        for (a = 0; s > a; a++) i = e[a],
    ...
    function A(e, t, n) {
        ...
        if (Z.isEmptyObject(f))"inline" === ("none" === c ? w(e.nodeName) : c) && (p.display = c);
            ...
            m ? "hidden" in m && (h = m.hidden) : m = vt.access(e, "fxshow", {}),
            o && (m.hidden = !h),
    ...
    function D(e, t, n) {
        ...
        u = c.props;
        for (j(u, c.opts.specialEasing); a > o; o++) if (i = tn[o].call(c, e, u, c.opts)) return i;
        return Z.map(u, N, c),
    ...
    function R(e, t, n, i) {
        ...
        function(t, r) {
            n || _n.test(e) ? i(e, r) : R(e + "[" + ("object" == typeof r ? t: "") + "]", r, n, i)
        });
    ...
    Z.extend({
        ...
        proxy: function(e, t) {
            ...
            Z.isFunction(e) ? (i = X.call(arguments, 2), r = function() {
    ...
    var rt = function(e) {
        function t(e, t, n, i) {
            ...
            if (!i && D) {
                ...
                if (x.qsa && (!H || !H.test(e))) {
                    if (p = d = O, h = t, m = 1 !== s && e, 1 === s && "object" !== t.nodeName.toLowerCase()) {
                        for (c = _(e), (d = t.getAttribute("id")) ? p = d.replace(wt, "\\$&") : t.setAttribute("id", p), p = "[id='" + p + "'] ", l = c.length; l--;) c[l] = p + f(c[l]);
        ...
        N = t.setDocument = function(e) {
            ...
            return i !== A && 9 === i.nodeType && i.documentElement ? (A = i, j = i.documentElement, n = i.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", Tt, !1) : n.attachEvent && n.attachEvent("onunload", Tt)), D = !C(i), x.attributes = r(function(e) {
            ...
            M = [], H = [], (x.qsa = vt.test(i.querySelectorAll)) && (r(function(e) {
                j.appendChild(e).innerHTML = "<a id='" + O + "'></a><select id='" + O + "-\f]' msallowcapture=''><option selected=''></option></select>",
                ...
                H.push(",.*:")
            })), (x.matchesSelector = vt.test(P = j.matches || j.webkitMatchesSelector || j.mozMatchesSelector || j.oMatchesSelector || j.msMatchesSelector)) && r(function(e) {
                x.disconnectedMatch = P.call(e, "div"),
                P.call(e, "[s!='']:x"),
                M.push("!=", at)
            }), H = H.length && new RegExp(H.join("|")), M = M.length && new RegExp(M.join("|")), t = vt.test(j.compareDocumentPosition), W = t || vt.test(j.contains) ? 
            function(e, t) {
        ...
        t.matchesSelector = function(e, n) {
            if ((e.ownerDocument || e) !== A && N(e), n = n.replace(dt, "='$1']"), !(!x.matchesSelector || !D || M && M.test(n) || H && H.test(n))) try {
                var i = P.call(e, n);
        ...
        t.attr = function(e, t) { (e.ownerDocument || e) !== A && N(e);
            ...
            i = n && U.call(k.attrHandle, t.toLowerCase()) ? n(e, t, !D) : void 0;
        ...
        k = t.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    var t,
                    n = !e[6] && e[2];
                    return ht.CHILD.test(e[0]) ? null: (e[3] ? e[2] = e[4] || e[5] || "": n && ft.test(n) && (t = _(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t), e[2] = n.slice(0, t)), e.slice(0, 3))
                }
            },
            filter: {
                TAG: function(e) {
                ...
                CLASS: function(e) {
                    var t = X[e + " "];
                    return t || (t = new RegExp("(^|" + nt + ")" + e + "(" + nt + "|$)")) && X(e, 
                    function(e) {
                    ...
                    function(e) {
                        ...
                        if (g) {
                            ...
                            if (h = [a ? g.firstChild: g.lastChild], a && y) {
                                for (u = g[O] || (g[O] = {}), c = u[e] || [], p = c[0] === q && c[1], f = c[0] === q && c[2], d = p && g.childNodes[p]; d = ++p && d && d[m] || (f = p = 0) || h.pop();) if (1 === d.nodeType && ++f && d === t) {
                                    u[e] = [q, p, f];
                                    break
                                }
                            } else if (y && (c = (t[O] || (t[O] = {}))[e]) && c[0] === q) f = c[1];
                            else for (; (d = ++p && d && d[m] || (f = p = 0) || h.pop()) && ((s ? d.nodeName.toLowerCase() !== v: 1 !== d.nodeType) || !++f || (y && ((d[O] || (d[O] = {}))[e] = [q, f]), d !== t)););
                            return f -= r,
                            f === i || f % i === 0 && f / i >= 0
                        }
                    }
        ...
        $ = t.compile = function(e, t) {
            ...
            o = Y[e + " "];
            if (!o) {
                for (t || (t = _(e)), n = t.length; n--;) o = y(t[n]),
        ...
        S = t.select = function(e, t, n, i) {
            ...
            return (c || $(e, d))(i, t, !D, n, bt.test(e) && u(t.parentNode) || t),
            n
        },
    ...
    Z.extend({
        ...
        ready: function(e) { (e === !0 ? --Z.readyWait: Z.isReady) || (Z.isReady = !0, e !== !0 && --Z.readyWait > 0 || (mt.resolveWith(V, [Z]), Z.fn.triggerHandler && (Z(V).triggerHandler("ready"), Z(V).off("ready"))))
        }
    }),
    Z.ready.promise = function(t) {
        return mt || (mt = Z.Deferred(), "complete" === V.readyState ? setTimeout(Z.ready) : (V.addEventListener("DOMContentLoaded", a, !1), e.addEventListener("load", a, !1))),
        mt.promise(t)
    },
    Z.ready.promise();
    ...
    Z.event = {
        ...
        remove: function(e, t, n, i, r) {
            ...
            h,
            m,
            g = vt.hasData(e) && vt.get(e);
            if (g && (l = g.events)) {
                for (t = (t || "").match(pt) || [""], c = t.length; c--;) if (s = Et.exec(t[c]) || [], p = m = s[1], h = (s[2] || "").split(".").sort(), p) {
                    for (d = Z.event.special[p] || {},
                    p = (i ? d.delegateType: d.bindType) || p, f = l[p] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = o = f.length; o--;) u = f[o],
                    !r && m !== u.origType || n && n.guid !== u.guid || s && !s.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (f.splice(o, 1), u.selector && f.delegateCount--, d.remove && d.remove.call(e, u));
                    a && !f.length && (d.teardown && d.teardown.call(e, h, g.handle) !== !1 || Z.removeEvent(e, p, g.handle), delete l[p])
        ...
        fix: function(e) {
            ...
            o = e,
            a = this.fixHooks[r];
            for (a || (this.fixHooks[r] = a = St.test(r) ? this.mouseHooks: $t.test(r) ? this.keyHooks: {}), i = a.props ? this.props.concat(a.props) : this.props, e = new Z.Event(o), t = i.length; t--;) n = i[t],
            e[n] = o[n];
    ...
    Z.extend({
        ...
        buildFragment: function(e, t, n, i) {
            ...
            for (u.textContent = "", f = 0; r = d[f++];) if ((!i || -1 === Z.inArray(r, i)) && (l = Z.contains(r.ownerDocument, r), o = v(u.appendChild(r), "script"), l && m(o), n)) for (c = 0; r = o[c++];) Ht.test(r.type || "") && n.push(r);
            return u
        },
    ...
    Z.fn.extend({
        ...
        html: function(e) {
            ...
            function(e) {
                ...
                if ("string" == typeof e && !jt.test(e) && !Wt[(Nt.exec(e) || ["", ""])[1].toLowerCase()]) {
                    e = e.replace(It, "<$1></$2>");
                    try {
                        for (; i > n; n++) t = this[n] || {},
        ...
        domManip: function(e, t) {
            ...
            f = e[0],
            m = Z.isFunction(f);
            if (m || c > 1 && "string" == typeof f && !Q.checkClone && Dt.test(f)) return this.each(function(n) {
                var i = u.eq(n);
                m && (e[0] = f.call(this, n, i.html())),
                i.domManip(e, t)
            });
    ...
    function(e, t) {
        Z.cssHooks[t] = {
            ...
            set: function(e, n, i) {
                var r = i && Xt(e);
                return C(e, n, i ? _(e, t, i, "border-box" === Z.css(e, "boxSizing", !1, r), r) : 0)
            }
        }
    }),
    ...
    function(e, t) {
        ...
        qt.test(e) || (Z.cssHooks[e + t].set = C)
    }),
    Z.fn.extend({
        css: function(e, t) {
            return gt(this, 
            function(e, t, n) {
                ...
                a = 0;
                if (Z.isArray(t)) {
                    for (i = Xt(e), r = t.length; r > a; a++) o[t[a]] = Z.css(e, t[a], !1, i);
                    return o
                }
    ...
    Z.Animation = Z.extend(D, {
        tweener: function(e, t) {
            ...
            for (var n, i = 0, r = e.length; r > i; i++) n = e[i],
            nn[n] = nn[n] || [],
            nn[n].unshift(t)
        },
    ...
    Z.extend({
        attr: function(e, t, n) {
            ...
            r,
            o = e.nodeType;
            return e && 3 !== o && 8 !== o && 2 !== o ? typeof e.getAttribute === _t ? Z.prop(e, t, n) : (1 === o && Z.isXMLDoc(e) || (t = t.toLowerCase(), i = Z.attrHooks[t] || (Z.expr.match.bool.test(t) ? on: rn)), void 0 === n ? i && "get" in i && null !== (r = i.get(e, t)) ? r: (r = Z.find.attr(e, t), null == r ? void 0: r) : null !== n ? i && "set" in i && void 0 !== (r = i.set(e, n, t)) ? r: (e.setAttribute(t, n + ""), n) : void Z.removeAttr(e, t)) : void 0
        },
    ...
    Z.fn.extend({
        ...
        toggleClass: function(e, t) {
            ...
            function(n) {
                ...
                if ("string" === n) for (var t, i = 0, r = Z(this), o = e.match(pt) || []; t = o[i++];) r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
    ...
    Z.extend({
        valHooks: {
            ...
            select: {
                get: function(e) {
                    for (var t, n, i = e.options, r = e.selectedIndex, o = "select-one" === e.type || 0 > r, a = o ? null: [], s = o ? r + 1: i.length, l = 0 > r ? s: o ? r: 0; s > l; l++) if (n = i[l], !(!n.selected && l !== r || (Q.optDisabled ? n.disabled: null !== n.getAttribute("disabled")) || n.parentNode.disabled && Z.nodeName(n.parentNode, "optgroup"))) {
                ...
                set: function(e, t) {
                    for (var n, i, r = e.options, o = Z.makeArray(t), a = r.length; a--;) i = r[a],
    ...
    Z.extend({
        ...
        ajax: function(e, t) {
            function n(e, t, n, a) {
                ...
                w,
                k = t;
                2 !== b && (b = 2, s && clearTimeout(s), i = void 0, o = a || "", x.readyState = e > 0 ? 4: 0, l = e >= 200 && 300 > e || 304 === e, n && (y = W(d, x, n)), y = O(d, y, x, l), l ? (d.ifModified && (w = x.getResponseHeader("Last-Modified"), w && (Z.lastModified[r] = w), w = x.getResponseHeader("etag"), w && (Z.etag[r] = w)), 204 === e || "HEAD" === d.type ? k = "nocontent": 304 === e ? k = "notmodified": (k = y.state, u = y.data, v = y.error, l = !v)) : (v = k, (e || !k) && (k = "error", 0 > e && (e = 0))), x.status = e, x.statusText = (t || k) + "", l ? h.resolveWith(f, [u, k, x]) : h.rejectWith(f, [x, k, v]), x.statusCode(g), g = void 0, c && p.trigger(l ? "ajaxSuccess": "ajaxError", [x, d, l ? u: v]), m.fireWith(f, [x, k]), c && (p.trigger("ajaxComplete", [x, d]), --Z.active || Z.event.trigger("ajaxStop")))
            }
            ...
            if (h.promise(x).complete = m.add, x.success = x.done, x.error = x.fail, d.url = ((e || d.url || kn) + "").replace(fn, "").replace(vn, Tn[1] + "//"), d.type = t.method || t.type || d.method || d.type, d.dataTypes = Z.trim(d.dataType || "*").toLowerCase().match(pt) || [""], null == d.crossDomain && (l = yn.exec(d.url.toLowerCase()), d.crossDomain = !(!l || l[1] === Tn[1] && l[2] === Tn[2] && (l[3] || ("http:" === l[1] ? "80": "443")) === (Tn[3] || ("http:" === Tn[1] ? "80": "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = Z.param(d.data, d.traditional)), M(bn, d, t, x), 2 === b) return x;
            c = Z.event && d.global,
    ...
    Z.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !Z(this).is(":disabled") && Ln.test(this.nodeName) && !Sn.test(e) && (this.checked || !Ct.test(e))
            }).map(function(e, t) {
                var n = Z(this).val();
    ...
    function(t, n, i) {
        ...
        o,
        a,
        s = t.jsonp !== !1 && (Dn.test(t.url) ? "url": "string" == typeof t.data && !(t.contentType || "").indexOf("application/x-www-form-urlencoded") && Dn.test(t.data) && "data");
        return s || "jsonp" === t.dataTypes[0] ? (r = t.jsonpCallback = Z.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(Dn, "$1" + r) : t.jsonp !== !1 && (t.url += (dn.test(t.url) ? "&": "?") + t.jsonp + "=" + r), t.converters["script json"] = function() {
        ...
        i.always(function() {
            e[r] = o,
            t[r] && (t.jsonpCallback = n.jsonpCallback, jn.push(r)),
    ...
    Z.fn.extend({
        offset: function(e) {
            ...
            o = i && i.ownerDocument;
            return o ? (t = o.documentElement, Z.contains(t, i) ? (typeof i.getBoundingClientRect !== _t && (r = i.getBoundingClientRect()), n = q(o), {
...
function(e) {
    ...
    w.prototype = {
        ...
        open: function(n) {
            ...
            t.bgOverlay || (t.bgOverlay = C("bg").on("click" + g, 
            function() {
                t.close()
            }), t.wrap = C("wrap").attr("tabindex", -1).on("click" + g, 
            function(e) {
            ...
            _("BeforeOpen"),
            t.st.showCloseBtn && (t.st.closeBtnInside ? (T(f, 
            function(e, t, n, i) {
            ...
            t.st.enableEscapeKey && r.on("keyup" + g, 
            function(e) {
        ...
        close: function() {
            t.isOpen && (_(c), t.isOpen = !1, t.st.removalDelay && !t.isLowIE && t.supportsTransition ? (t._addClassToMFP(y), setTimeout(function() {
                t._close()
            },
        ...
        appendContent: function(e, n) {
            t.content = e,
            e ? t.st.showCloseBtn && t.st.closeBtnInside && t.currTemplate[n] === !0 ? t.content.find(".mfp-close").length || t.content.append($()) : t.content = e: t.content = "",
            _(d),
        ...
        parseEl: function(n) {
            ...
            if (r.tagName ? r = {
                ...
                for (var o = t.types, a = 0; o.length > a; a++) if (r.el.hasClass("mfp-" + o[a])) {
                    i = o[a];
                    break
                }
            ...
            getInline: function(n, i) {
                if (j(), n.src) {
                    ...
                    if (o.length) {
                        ...
                        a && a.tagName && (I || (E = r.hiddenClass, I = C(E), E = "mfp-" + E), N = o.after(I).detach().removeClass(E)),
    ...
    e.magnificPopup.registerModule("image", {
        ...
        proto: {
            ...
            _onImageHasSize: function(e) {
                e.img && (e.hasSize = !0, W && clearInterval(W), e.isCheckingImgSize = !1, _("ImageHasSize", e), e.imgHidden && (t.content && t.content.removeClass("mfp-loading"), e.imgHidden = !1))
            },
            ...
            getImage: function(n, i) {
                var r = 0,
                o = function() {
                    n && (n.img[0].complete ? (n.img.off(".mfploader"), n === t.currItem && (t._onImageHasSize(n), t.updateStatus("ready")), n.hasSize = !0, n.loaded = !0, _("ImageLoadComplete")) : (r++, 200 > r ? setTimeout(o, 100) : a()))
                },
                a = function() {
    ...
    B = function(e) {
        if (t.currTemplate[F]) {
            ...
            n.length && (e || (n[0].src = X), t.isIE8 && n.css("display", e ? "block": "none"))
        }
    };
    e.magnificPopup.registerModule(F, {
        options: {
            ...
            patterns: {
                youtube: {
                    index: "http://www.wehaha.com/zb_users/theme/ydblack/style/js/youtube.com",
                    id: "v=",
    ...
    e.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                ...
                n && n.enabled ? (a += " mfp-gallery", T(p + i, 
                function() {
                ...
                function() {
                    if (t.items.length > 1 && n.arrows && !t.arrowLeft) {
                        ...
                        t.isIE7 && (C("b", r[0], !1, !0), C("a", r[0], !1, !0), C("b", a[0], !1, !0), C("a", a[0], !1, !0)),
...
function() {
    window.reply_comment = function(e) {
        var t,
        n,
        i;
        return t = $(e).parents(".comment_details").attr("data-comment-id"),
        i = $(e).parents(".comment_details").find(".avatar img").attr("alt"),
        n = "In reply to " + i + "<span onclick='delete_reply_comment(this)'>X</span>",
        $("form.comment_form input.re_comment_id").remove(),
        $("form.comment_form").append("<input class='re_comment_id' type='hidden' name='comment[parent_id]' value='" + t + "'>"),
        $("form.comment_form span.reply_msg").html(n),
        $("textarea#post").focus()
    },
...
$(document).ready(function() {
    ...
    function() {    	
        t = parseInt($('.ps-scrollbar-y').css('top')) + parseInt($('.ps-scrollbar-y').css('height'));
        if (t === parseInt($(this).css('height'))&&!$(".J_fastSectionList").hasClass('is_ajaxing')) {
        	$(".J_fastSectionList .bugs-more a").text('Loading...');
        	$(".J_fastSectionList").addClass('is_ajaxing');
            ...
            $.get("", {
            	...
            	if(data){
                    $(".J_fastSectionList .wrap").attr('data-page', page);
                    $(".J_fastSectionList").removeClass('is_ajaxing');
                    $(".fast-news-panel").append($(data).fadeIn(300));
            	}else{
            		$(".J_fastSectionList .bugs-more a").text('没有可加载的信息了');
            	}
            })
        }
    })
...
function() { (!window.BAIDU_CLB_fillSlot || $("html").is(".portable-device")) && (window.BAIDU_CLB_fillSlot = function() {}),
    ...
    jQuery(function() {
        ...
        function() {
            void 0 !== $(".require-login").data().uid && "" !== $(".require-login").data().uid || !confirm("\u8bf7\u767b\u5f55\u540e\u7ee7\u7eed\u64cd\u4f5c\uff01 (\u25cf\u2014\u25cf)") || (window.location.href = "http://www.wehaha.com/users/auth/krypton")
        })
    })
}.call(this);